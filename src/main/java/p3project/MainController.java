...
public class MainController {
	 ...
	 * }
	 * 
	 * private <T> void compareFields(T requestObject, T storedObject) throws
	 * ClassNotFoundException{ // fjern generic?
	 * Field[] fields = requestObject.getClass().getDeclaredFields(); // burde være
	 * lige meget hvilken en + ingen inheritence, igen lige meget (for nu)
	 ...
	 * Changelog log = Changelog.create(user, requestObject,
	 * requestObject.getName(), before, after); // getName fix?
	 * logRepository.save(log);
	 * field.set(storedObject, after);
	 * }
	 * } catch (IllegalAccessException e) { // skal være der for field.get kan
	 * bruges, burde ikke aktivere: setAccessible(true)
	 * throw new RuntimeException(e);
	 * }
	 * }
	 * 
	 * if (requestObject instanceof Sponsor) sponsorRepository.save(storedObject);
	 * // opdater i stedet for gem??
	 * else if (requestObject instanceof Contract)
	 * contractRepository.save(storedObject);
	 * else if (requestObject instanceof Service)
	 * serviceRepository.save(storedObject);
